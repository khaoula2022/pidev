...
use EventBundle\Entity\promotion;
...
class promotionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $promotions = $em->getRepository('EventBundle:promotion')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('EventBundle\Form\promotionType', $promotion);
    ...
    {
        $deleteForm = $this->createDeleteForm($promotion);
        $editForm = $this->createForm('EventBundle\Form\promotionType', $promotion);
